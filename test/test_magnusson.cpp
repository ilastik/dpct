...
BOOST_AUTO_TEST_CASE(minimal_test_magnusson) {
    ...
    Graph::NodePtr n1 =
        g.addNode(0, {0, 3, -10}, {0.0}, {0.0}, true, false, std::make_shared<NameData>("Timestep 1: Node 1"));
    Graph::NodePtr n2 =
        g.addNode(1, {0, 3, -10}, {0.0}, {0.0}, false, true, std::make_shared<NameData>("Timestep 2: Node 1"));
...
BOOST_AUTO_TEST_CASE(two_cell_test_magnusson) {
    ...
    Graph::NodePtr n1 =
        g.addNode(0, {0, 3, 5, -10}, {0.0}, {0.0}, true, false, std::make_shared<NameData>("Timestep 1: Node 1"));
    Graph::NodePtr n2 =
        g.addNode(1, {0, 3, 4, -10}, {0.0}, {0.0}, false, true, std::make_shared<NameData>("Timestep 2: Node 1"));
...
BOOST_AUTO_TEST_CASE(magnusson_no_swap_failure_case) {
    ...
    Graph::NodePtr n1 =
        g.addNode(0, {0, 1}, {0.0}, {0.0}, true, false, std::make_shared<NameData>("Timestep 1: Node 1"));
    Graph::NodePtr n2 =
        g.addNode(0, {0, 1}, {0.0}, {0.0}, true, false, std::make_shared<NameData>("Timestep 1: Node 2"));

    Graph::NodePtr n3 =
        g.addNode(1, {0, 5}, {0.0}, {0.0}, false, false, std::make_shared<NameData>("Timestep 2: Node 1"));
    Graph::NodePtr n4 =
        g.addNode(1, {0, 15}, {0.0}, {0.0}, false, false, std::make_shared<NameData>("Timestep 2: Node 2"));

    Graph::NodePtr n5 =
        g.addNode(2, {0, 2}, {0.0}, {0.0}, false, true, std::make_shared<NameData>("Timestep 3: Node 1"));
    Graph::NodePtr n6 =
        g.addNode(2, {0, 1}, {0.0}, {0.0}, false, true, std::make_shared<NameData>("Timestep 3: Node 2"));
...
BOOST_AUTO_TEST_CASE(magnusson_simple_swap_test_with_app_dis) {
    ...
    Graph::NodePtr n3 =
        g.addNode(1, {0, 10}, {10.0}, {0.0}, false, true, std::make_shared<NameData>("Timestep 2: Node 1"));
    Graph::NodePtr n4 =
        g.addNode(1, {0, 1}, {0.0}, {0.0}, false, true, std::make_shared<NameData>("Timestep 2: Node 2"));
...
BOOST_AUTO_TEST_CASE(magnusson_two_possible_swaps) {
    ...
    Graph::NodePtr n2 =
        g.addNode(0, {0, 1}, {0.0}, {0.0}, true, false, std::make_shared<NameData>("Timestep 1: Node 2"));
    Graph::NodePtr n10 =
        g.addNode(0, {0, 2}, {0.0}, {0.0}, true, false, std::make_shared<NameData>("Timestep 1: Node 3"));
    ...
    Graph::NodePtr n4 =
        g.addNode(1, {0, 15}, {0.0}, {0.0}, false, false, std::make_shared<NameData>("Timestep 2: Node 2"));
    Graph::NodePtr n11 =
        g.addNode(0, {0, 2}, {0.0}, {0.0}, false, false, std::make_shared<NameData>("Timestep 2: Node 3"));
    ...
    Graph::NodePtr n6 =
        g.addNode(2, {0, 1}, {0.0}, {0.0}, false, true, std::make_shared<NameData>("Timestep 3: Node 2"));
    Graph::NodePtr n12 =
        g.addNode(2, {0, 1}, {0.0}, {0.0}, false, true, std::make_shared<NameData>("Timestep 3: Node 3"));
...
void buildGraph(Graph &g) {
    ...
    // -----------------------------------------------------
    // Timestep 1
    Graph::NodePtr n_1_1 = g.addNode(0, {0, 3, 2}, appearanceScore, disappearanceScore, true, false,
                                     std::make_shared<NameData>("Timestep 1: Node 1"));

    Graph::NodePtr n_1_2 = g.addNode(0, {0, 2, 7}, appearanceScore, disappearanceScore, true, false,
                                     std::make_shared<NameData>("Timestep 1: Node 2"));

    Graph::NodePtr n_1_3 = g.addNode(0, {0, 3, -2}, appearanceScore, disappearanceScore, true, false,
                                     std::make_shared<NameData>("Timestep 1: Node 3"));

    // -----------------------------------------------------
    // Timestep 2
    Graph::NodePtr n_2_1 = g.addNode(1, {0, 4, 2}, appearanceScore, disappearanceScore, false, false,
                                     std::make_shared<NameData>("Timestep 2: Node 1"));

    Graph::NodePtr n_2_2 = g.addNode(1, {0, 2, 0}, appearanceScore, disappearanceScore, false, false,
                                     std::make_shared<NameData>("Timestep 2: Node 2"));

    Graph::NodePtr n_2_3 = g.addNode(1, {0, 2, -2}, appearanceScore, disappearanceScore, false, false,
                                     std::make_shared<NameData>("Timestep 2: Node 3"));

    Graph::NodePtr n_2_4 = g.addNode(1, {0, 2, 0}, appearanceScore, {-1.0, -1.0}, false, false,
    ...
    // -----------------------------------------------------
    // Timestep 3
    Graph::NodePtr n_3_1 = g.addNode(2, {0, 3, 5}, appearanceScore, disappearanceScore, false, false,
                                     std::make_shared<NameData>("Timestep 3: Node 1"));

    Graph::NodePtr n_3_2 = g.addNode(2, {0, 2, 2}, appearanceScore, disappearanceScore, false, false,
                                     std::make_shared<NameData>("Timestep 3: Node 2"));

    Graph::NodePtr n_3_3 = g.addNode(2, {0, 3, 0}, appearanceScore, disappearanceScore, false, false,
                                     std::make_shared<NameData>("Timestep 3: Node 3"));
    ...
    // -----------------------------------------------------
    // Timestep 4
    Graph::NodePtr n_4_1 = g.addNode(3, {0, 4, 3}, appearanceScore, disappearanceScore, false, true,
                                     std::make_shared<NameData>("Timestep 4: Node 1"));

    Graph::NodePtr n_4_2 = g.addNode(3, {0, 2, 1}, appearanceScore, disappearanceScore, false, true,
                                     std::make_shared<NameData>("Timestep 4: Node 2"));

    Graph::NodePtr n_4_3 = g.addNode(3, {0, 2, -4}, appearanceScore, disappearanceScore, false, true,
                                     std::make_shared<NameData>("Timestep 4: Node 3"));

    Graph::NodePtr n_4_4 = g.addNode(3, {0, 4, 2}, appearanceScore, disappearanceScore, false, true,
                                     std::make_shared<NameData>("Timestep 4: Node 4"));
...
class PositionData2D : public UserData {
  public:
    PositionData2D(double x, double y) : x_(x), y_(y) {}
...
BOOST_AUTO_TEST_CASE(test_full_magnusson_motion_model)
{
    ...
    Magnusson::MotionModelScoreFunction momoscofu = [&](Node* a, Node* b, Node* c)
    {
        ...
        if(a == nullptr || b == nullptr || c == nullptr || g.isSpecialNode(a) || g.isSpecialNode(b) ||
g.isSpecialNode(c))
        {
            return -10.0;
        }
